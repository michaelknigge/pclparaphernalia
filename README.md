...
# Release
This branch contains the latest version 3.2.1.0, released 2018-04-21. The following files are available for download:
...
There is also a [new installer available](https://github.com/michaelknigge/pclparaphernalia/releases/download/v3.2.1.0/PCLParaphernalia-Setup.exe) for download.
